   ...
   function showResultsWithLazyLoading2() {
    ...
    function addClickListener(element, placeName, placeAddress, placeTel, placeimg, placeLatitude, placeLongitude) {
        element.addEventListener("click", function() {
            ...
            showDetail2(placeName, placeAddress, placeTel, placeimg, placeLatitude, placeLongitude);
        });
    }

    var resultDetailDiv2 = document.getElementById("resultDetail");

    function showDetail2(placeName, placeAddress, placeTel, placeimg, placeLatitude, placeLongitude) {
