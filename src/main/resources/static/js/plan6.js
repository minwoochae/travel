   ...
   function showResultsWithLazyLoading3() {
    ...
    function addClickListener(element, placeName, placeAddress, placeimg, placeLatitude, placeLongitude) {
        element.addEventListener("click", function() {
            ...
            showDetail3(placeName, placeAddress, placeimg, placeLatitude, placeLongitude);
        });
    }

    var resultDetailDiv3 = document.getElementById("resultDetail3");

    function showDetail3(placeName, placeAddress, placeimg, placeLatitude, placeLongitude) {
