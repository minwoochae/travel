...
document.getElementById("searchButton3").addEventListener("click", function() {
   ...
   function showResultsWithLazyLoading3() {
        var searchResultsElement = document.getElementById("results3");
        ...
        for (let i = startIndex; i < endIndex; i++) {
            ...
            addClickListener3(resultItem, data.placeName, data.placeAddress, data.placeTel, data.placeimg, data.placeLatitude, data.placeLongitude);
        	}
    ...
    function addClickListener3(element, placeName, placeAddress, placeTel, placeimg, placeLatitude, placeLongitude) {
        element.addEventListener("click", function() {
            ...
            showDetail3(placeName, placeAddress, placeTel, placeimg, placeLatitude, placeLongitude);
        });
    }

    var resultDetailDiv3 = document.getElementById("resultDetail3");

    function showDetail3(placeName, placeAddress, placeTel, placeimg,  placeLatitude, placeLongitude) {
...
function insertContent3() {
    ...
    <button type="button" class="btn btn-outline-secondary align-self-center justify-content-md-end" onclick="deleteContent3(event)" style="height:30px; line-height: 0; 
